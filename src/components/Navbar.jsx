    ...
    <aside className="fixed left-0 top-0 z-50 flex h-screen w-60 flex-col border-r border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-900">
      ...
      <nav className="flex-1 space-y-1 px-3 py-5">
        ...
        {!user && (
          <NavLink
            to="/signin"
            className="mt-4 flex w-full items-center justify-center rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700"
          >
            Log In
          </NavLink>
        )}
      ...
      <div className="border-t border-gray-100 p-4 dark:border-gray-800">
        {user ? (
          <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3 dark:bg-gray-800">
            <div className="flex h-9 w-9 items-center justify-center rounded-full  from-indigo-500 to-purple-600 text-xs font-semibold text-white">
